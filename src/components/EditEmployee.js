...
<Button onClick={handleOpen}>Click here For Edit</Button>
    ...
    <input className='form-control' name='phonenumber' placeholder='Enter phonenumber' value={selectedEmployee1.phonenumber} onChange={(e)=>eventHandler(e)}/>
    <label className='form-lable' >Email</label>
    <input className='form-control' name='email' type='email' placeholder='Enter email' value={selectedEmployee1.email} onChange={(e)=>eventHandler(e)}/>
    {/* <label className='form-lable'>Age</label>
    <input className='form-control' name='age' type='number' placeholder='Enter Age' value={selectedEmployee1.age} onChange={(e)=>eventHandler(e)}/> */}
    <Button variant="secondary" onClick={()=>{closeModal()}}>Close</Button>
    <Button variant="primary" onClick={()=>{saveChanges()}}>Save changes</Button>
